...
public class CSVTable
{
    ...
    private readonly ArrayList<string> m_columnNameList;
    private readonly ArrayList<CSVColumn> m_columnList;
    private readonly ArrayList<CSVRow> m_rowList;
    ...
    public CSVTable(CSVNode node, int size)
    {
        ...
        m_columnList = new ArrayList<CSVColumn>();
        m_rowList = new ArrayList<CSVRow>();
